...
public struct UserCreditRewardExpired: Codable, Hashable {
    ...
    public init(reward: CreditReward, expiredAt: Date, createdAt: Date, updatedAt: Date?) {
        self.reward = reward
