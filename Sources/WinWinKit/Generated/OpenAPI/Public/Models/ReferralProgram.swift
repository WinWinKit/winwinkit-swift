...
public struct ReferralProgram: Codable, Hashable {
    ...
    /** The program rewards */
    public private(set) var rewards: ReferralProgramRewards
    /** The program created at */
    public private(set) var createdAt: Date
    /** The program updated at */
    public private(set) var updatedAt: Date?

    public init(id: String, name: String, description: String?, metadata: AnyCodable?, distributionPercentage: Int, limit: Int, rewards: ReferralProgramRewards, createdAt: Date, updatedAt: Date?) {
        self.id = id
        self.name = name
...
extension ReferralProgram: Identifiable {}
