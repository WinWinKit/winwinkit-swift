...
public struct UserBasicRewardExpired: Codable, Hashable {
    ...
    public init(reward: BasicReward, expiredAt: Date, createdAt: Date, updatedAt: Date?) {
        self.reward = reward
