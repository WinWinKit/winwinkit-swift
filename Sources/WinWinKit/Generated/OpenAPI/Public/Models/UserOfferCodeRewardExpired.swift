//
// UserOfferCodeRewardExpired.swift
//
...
public struct UserOfferCodeRewardExpired: Codable, Hashable {
    ...
    public init(reward: OfferCodeReward, expiredAt: Date, createdAt: Date, updatedAt: Date?) {
        self.reward = reward
